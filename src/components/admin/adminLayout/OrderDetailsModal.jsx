      ...
      <Box sx={{ width: '80%', maxHeight: '80vh', bgcolor: 'background.paper', padding: 4, margin: 'auto', marginTop: '5%', borderRadius: 1, overflowY: 'auto' }}>
        ...
        {orders.map((order) => (
          <Box key={order.id} sx={{ mt: 2, borderBottom: '1px solid #ccc', paddingBottom: 2 }}>
            ...
            <Typography variant="body1"><strong>Order Requirement:</strong> {order.orderRequirement}</Typography>
            ...
            <Typography variant="body1"><strong>Status:</strong> <span style={{ color: getStatusColor(order.status) }}>{order.status}</span></Typography>
